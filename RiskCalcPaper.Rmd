...
survplot(objNpsurv, ylim = c(.9,1), xlab = "Years After TKA", ylab = "Percent of TKAs Unrevised", conf.type="log-log", levels.only=T, conf="none", lty = c(2,1,5,4), col = c(2,1,3,4), lwd = 3, time.inc=1, label.curves=F)
legend(x=1.4, y = 1,cex=1, bty="n", legend=c("Non User", "First Tertile ( < 3.7 ME/ Day)", "Second Tertile (3.7 - 14.3 ME/ Day)", "Third Tertile ( > 14.3 ME/ Day)"), col = c(1,2,3,4), lty = c(1,2,5,4), lwd=3, y.intersp=.5)
